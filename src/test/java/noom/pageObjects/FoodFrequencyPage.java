...
public class FoodFrequencyPage extends BaseClass {

	private static WebElement element;
	
	public FoodFrequencyPage(WebDriver driver) {
		super(driver);
	}
	...
	public static WebElement btn_questionOptionChecked() {
		element = null;
		try {
			element = driver.findElement(By.xpath("//*[@id=\"root\"]/div/section/div[2]/div/div[2]/div[1]/div/label[3]"));
		} catch (Exception e) {
			throw (e);
		}
		return element;
