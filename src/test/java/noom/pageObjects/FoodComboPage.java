...
public class FoodComboPage extends BaseClass {

	private static WebElement element;
	
	public FoodComboPage(WebDriver driver) {
		super(driver);
	}
	...
	public static WebElement btn_questionOptionChecked() {
		element = null;
		try {
			element = driver.findElement(By.xpath("//*[@id=\"root\"]/div/section/div[2]/div/div[2]/div[1]/div/label[2]"));
		} catch (Exception e) {
			throw (e);
		}
		return element;
